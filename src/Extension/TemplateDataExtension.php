...
class TemplateDataExtension extends Extension
{
    ...
    /**
     * The SiteConfig this extension is applied to - the record whose $owns declarations the
     * PublishesOwnedRecords trait traverses.
     *
     * Narrowed here because SilverStripe\Core\Extension::getOwner() is untyped, and the trait
     * calls findOwned(), validate() and reads ObsoleteClassName/ID off the result.
     *
     * @return DataObject
     */
